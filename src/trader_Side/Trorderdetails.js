...
export default function VerticalTabs() {
    ...
    const [tableRows, setTableRows] = React.useState([{ tippanNumber: '123456'},]);
    ...
    const [weftRow, setWeftRow] = React.useState([{ date: '8-07-2024', gatepassno: '1234455' },]);
    // const weftaddrow = () => {
    ...
    //     setWeftRow(updatedRows);
    // };
    const [fabricRow, setFabricRow] = React.useState([{ date: '09-07-2024', gatepassno: '124', photopath: '', meter: '22', weight: '5885' },]);
    ...
    const fabricphoto = (index, photo) => {
        const updatedRows = [...fabricRow];
        updatedRows[index].photopath = photo;
        setFabricRow(updatedRows);
    };

    const [returnRow, setReturnRow] = React.useState([{ meter: '52', cutpiece: '54', yarncount: '875', gpno: '785' }]);
    // const returnaddrow = () => {
                                ...
                                <tbody>
                                    {tableRows.map((row, index) => (
                                        <tr key={index}>
                                            ...
                                            {/*                                           
                                            <td style={{ color: 'red', fontSize: '25px', cursor: 'pointer' }} 
