...
const Update_myenquiries = () => {
    ...
    const enquiries = [
      {
        number: 'EN428', date: '2024-06-06', BookingFrom: '2024-06-06', BookingTo: '2024-06-21', FabricQuality: '64/5*98/50*50:68', FabricLength: '500000.000', LoomRequired: 50, AgentName: 'Kedar',
        MachineType: 'Airjet', SheddingType: 'CAM', Width: '210.000', RPM: '1200.00', NoOfFrames: '5', NoOfFeeders: '3', SelvedgeJacquard: 'Required'
      },
      { number: 'EN429', date: '2024-06-07' },
      { number: 'EN430', date: '2024-06-08' },
    ];
    const navigate = useNavigate();
    const handleCardClick = () => {
        navigate('../updatemyenquiriesform');
    };
    ...
    return (
        <div className='update-myenquiries-container'>
            ...
            <div onClick={handleCardClick} className='update-myenquiries' style={{ height: '80vh', display: 'grid', gridTemplateColumns: 'repeat(9, 1fr)', gridTemplateRows: 'repeat(5,1fr)', gap: '20px'}}>
                {enquiries.map((enquiry) => (
                    <div className='update-myenquiries-card'>
